from .losses import (TripletLossNoHardMining, ProtoRegularization, ProtoCFLoss,
                     ...
                     IncrementalPNormPTLoss, IncrementalNetworkFixLoss, CenterLoss, ProtoFixLoss,
                     TripletLoss_pytorch, IncrementalCPTFixPNLoss, IncrementalKPTFixPNLoss)
...
__all__ = [
    ...
    'IncrementalCPTFixPNLoss',
    'IncrementalKPTFixPNLoss',
