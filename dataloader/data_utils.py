...
def get_dataloader(args,session):
    if session == 0:
        trainset, trainloader, testset, testloader = get_base_dataloader(args)
    else:
        trainset, trainloader, testset, testloader = get_new_dataloader(args)
...
def get_base_dataloader(args):
    ...
    if args.dataset == 'cub200':
        trainset = args.Dataset.CUB200(root=args.dataroot,
                                       train=args.train,
                                       index=class_index,
                                       base_sess=True,
